...
function install_Kritro() {
    ...
    *)
    ...
    #   Kritro
        ...
        wget -O /root/Kritro.tar.gz https://网址
        wget -O /root/Script.pvf https://网址
        wget -O /root/publickey.pem https://网址
    fi
    cp Kritro.tar.gz /
    cd /
